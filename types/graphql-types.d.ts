...
export type AllContentfulBlogPostQuery = { allContentfulBlogPost: { nodes: Array<(
      ...
      & { eyeCatch?: Maybe<{ file?: Maybe<Pick<ContentfulAssetFile, 'url'>> }> }
    )> } };
...
export type ContentfulBlogPostQuery = { contentfulBlogPost?: Maybe<(
    ...
    )>, body?: Maybe<Pick<ContentfulBlogPostBody, 'raw'>>, eyeCatch?: Maybe<{ file?: Maybe<Pick<ContentfulAssetFile, 'url'>> }> }
  )> };
